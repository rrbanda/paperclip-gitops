 ...
 */
import { createSandbox, waitForSandboxReady, execInSandbox, deleteSandbox, healthCheck, listSandboxes, } from "./openshell-client.js";
...
async function execute(ctx) {
    ...
    const sandboxName = reuseStrategy === "per-agent"
        ...
        : `pc-${runId.slice(0, 8)}`;
    const wakePrompt = asString(context.paperclipTaskMarkdown || context.wakePrompt, `Task: ${asString(context.issueTitle, "No task assigned")}`);
...
export const openshellDirectAdapter = {
